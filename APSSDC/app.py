        ...
        if request.method=='POST':
            ...
            if user:
                ...
                try:
                    ...
                    student_image_file_name_in_s3 = student_name + "_image_file"
                    s3 = boto3.client('s3')
                    ...
                    try:
                        ...
                        Bucket=custombucket,
                        Key=student_image_file_name_in_s3,
                        Body=file,
                        ACL='public-read'
                        )
                        ...
                        cursor.execute(insert_sql,(name,gname,dob,password,address,tenth,inter,mobile,object_url))
                        db_conn.commit()
                ...
                return render_template("registration_completed.html", name=name,roll=Rollno,image_url=object_url)
            else:
                return "Access denied."
    except Exception as e:
        return str(e)
